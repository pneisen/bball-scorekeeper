...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {players: a, playerName: b, playerId: c, plays: d, currentPlayerId: e, currentPlayId: f};
	});
var _user$project$Main$Player = F3(
	function (a, b, c) {
		return {id: a, name: b, points: c};
	});
var _user$project$Main$new = function (model) {
	var newPlayer = A3(_user$project$Main$Player, model.currentPlayerId, model.playerName, 0);
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			players: A2(_elm_lang$core$List_ops['::'], newPlayer, model.players),
			playerName: '',
...
var _user$project$Main$save = function (model) {
	...
	if (_p0.ctor === 'Just') {
		return A2(_user$project$Main$edit, _p0._0, model);
	} else {
		return _user$project$Main$new(model);
	}
};
					...
					model,
					{
						players: A2(
							...
							function (player) {
								return _elm_lang$core$Native_Utils.eq(player.id, id) ? _elm_lang$core$Native_Utils.update(
									player,
									{points: player.points + _p3}) : player;
							},
							model.players),
						plays: A2(
							_elm_lang$core$List_ops['::'],
							A3(_user$project$Main$Play, model.currentPlayId, id, _p3),
							model.plays),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$pointsTotal(model)
			]));
};
